...
response = requests.get("https://prices.azure.com/api/retail/prices?$filter= armRegionName eq 'eastus'")
# and serviceName eq 'Virtual Machines'")

# Set your file location and filename to save your json and excel file
filelocation = r'C:\Git\localrepo\AzureRetailPrices'
filename = 'azureretailprices_vm_scus'

# Create an array to store price listls
priceitems= []
